...
public class InputProcess{
	...
	public static void ProcessFile(String filePath) throws IOException {
		...
		if (filePath == null){
			InputStream in = InputProcess.class.getResourceAsStream("Input");
	...
	public static void MapTokentoIntegerValue(){
		...
		while (it.hasNext()) {
			...
			float integerValue = new RomanToDecimalNum().romanToDecimal(token.getValue().toString());
	...
	private static void deCodeMissingQuery(String query){
		...
		float valueOfElementInDecimal = new RomanToDecimalNum().romanToDecimal(stringBuilder.toString());
